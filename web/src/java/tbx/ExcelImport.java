            ...
            for (int i = 2; i < nrows; i++) {
                ...
                try {
                    ...
                    if (!parentconcept.isEmpty()) {
                        ...
                        lexicalsense.parent = "http://copyrighttermbank.linkeddata.es/resource/" + parentconcept;
                    }
                   ...
                   // System.out.println(term10+" "+le31.getURI());
                        ...
                        lexicalentry.base = base ; //"http://tbx2rdf.lider-project.eu/converter/resource/cc/";
